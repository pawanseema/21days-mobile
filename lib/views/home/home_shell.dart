...
class HomeShell extends StatelessWidget {
  ...
  /// Tab bodies share a centered max-width column on wide layouts.
  static List<Widget> get _pages => [
        const AppContentWidth(child: ResourcesScreen()),
        const AppContentWidth(child: LiveScreen()),
  ...
  Widget build(BuildContext context) {
    ...
    // Type density is applied in [MaterialApp.builder] (see main.dart).
